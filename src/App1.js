import {buttonImageStyle, paragraphStyle, containerStyle, containerStyle2 } from './styles';
...
function App() {
  ...
  return (
    <div >
      ...
      <img style={buttonImageStyle} src={buttonImage} alt="Button" onClick={handleClick}  />
      
 
      {showImage && (
        <img 
          src={graph} //in here put in image of graphs 
          alt="Popped up" 
